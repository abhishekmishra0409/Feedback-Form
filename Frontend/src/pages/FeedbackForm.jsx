...
const FeedbackForm = () => {
    ...
    return (
        <div>
            ...
            <div className="mainContainer">
                <h2 style={{width: '100%'}} className='mainHead'>Course Exit Survey</h2>
                <p style={{color: 'grey', paddingBottom: '20px'}}>Please select Survey Form</p>
                <div className='centerButtons'>
                    <button className="button" onClick={() => {
                        window.location.href = "https://course-exit-survey.vercel.app/";
                    }}>
                        Course Exit Survey
                        <svg fill="currentColor" viewBox="0 0 24 24" className="icon">
                            <path
